...
import 'package:flutter_application_1/features/dosen/models/dosen_model.dart';
import 'package:flutter_application_1/features/dosen/repositories/dosen_repositories.dart';
...
class DosenNotifier extends StateNotifier<AsyncValue<List<DosenModel>>> {
  ...
  Future<void> removeSelectedUser(String userId) async {
